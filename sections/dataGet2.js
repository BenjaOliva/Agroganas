...
const getProducts = () => db.collection("Productos").where("Categoria", "==", categoria).get();
    ...
    <div class="row no-gutters">
        ...
        <aside class="col-sm-3">
            <div class="info-aside">
                ...
                <br>
                <p>
                <a href="producto.html?id=${doc.id}" class="btn btn-primary btn-block">Ver Detalles</a>
...
function getOneProduct(idToSearch) {
    ...
    docRef.get().then((doc) => {
        if (doc.exists) {
            ...
            document.getElementById('btnDetailsPhotos').setAttribute('onclick','modalMedia("'+ productIdDetails + '")');
            document.getElementById('section-title').innerHTML = 'Agroganas · ' + datosGet.Categoria;
